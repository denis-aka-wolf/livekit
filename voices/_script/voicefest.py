...
_LANGUAGES = {
    ...
    "bg_BG": Language("български", "Bulgarian", "Bulgaria"),
    ...
    "es_AR": Language("Español", "Spanish", "Argentina"),
    ...
    "id_ID": Language("Bahasa Indonesia", "Indonesian", "Indonesia"),
    ...
    "te_IN": Language("తెలుగు", "Telugu", "India"),
