...
Для постоянного мониторинга состояния системы создан скрипт `scripts/performance_monitor.sh`, который позволяет:

- Проверить статус всех контейнеров
- Получить последние логи сервисов
- Проверить использование ресурсов
- Протестировать доступность API эндпоинтов
...
Скрипт предоставляет информацию о состоянии всех ключевых компонентов системы:
- LLM сервера (llama_cpp)
- STT сервера (whisper)
- LiveKit сервера
